class CommandLineInterface
  ...
  def create_new_user
    ...
    # check for special conditions in input or if username exists
    # otherwise proceed to #build_profile with given username
  ...
  def choose_location
    ...
    [
      ...
      "Chicago",
      "Los Angeles"
      ]-current_location # subtract arrays to remove user location
